...
Portal de Serviços Públicos de Várzea Grande
...
**tipo\_status:** AB — Chamado aberto pelo cidadão; AN — Em análise pela equipe responsável; EX — Em execução no campo; CO — Serviço concluído; CA — Chamado cancelado.
...
* ***Rule 5 —** em observacao\_chamado: impede UPDATE e DELETE em observações já registradas, para todos os perfis, preservando o histórico da comunicação.*
...
| prazo\_amarelo\_dias | INTEGER, NOT NULL, DEFAULT 15 | Dias sem resolução para semáforo amarelo; alterável apenas por ateste do Secretário Municipal |
| prazo\_vermelho\_dias | INTEGER, NOT NULL, DEFAULT 30 | Dias sem resolução para semáforo vermelho; alterável apenas por ateste do Secretário Municipal |
