# Source: https://www.gov.br/ds/padroes/writing/principios-writing
...
Recomendado: Digite seu e-mail para acessar a primeira aula.
...
Lembre-se de padronizar o alinhamento de forma consistente em todas as telas.
...
Quando possível, apresente o conteúdo em forma de listas;
...
Recomendado: Quero cancelar essa ação.
Não recomendado: Não quero cancelar essa ação.
Comece com o objetivo da ação

Prefira começar o texto com o objetivo e o resultado da interação.

Recomendado: Consulte seu extrato acessando as opções do perfil.
Não recomendado: Acesse as opções do perfil para consultar seu extrato.
...
Recomendado: Exclua um item do formulário.
Não recomendado: Delete um item do formulário.
Use números

Dê preferência para os numerais ao invés de escrever por extenso, principalmente em aplicativos móveis. Os usuários entendem mais rapidamente e, como os números são menores, ganha-se espaço na tela.

Recomendado: Você tem 4 novas mensagens.
Não recomendado: Você tem quatro novas mensagens.
...
Não recomendado: Vocês chegaram ao final do curso, parabéns!
Prefira a voz ativa e não a passiva
...
Recomendado: Utilize o botão Pesquisar.
Não recomendado: O botão Pesquisar deve ser utilizado.

A exceção é quando você deseja enfatizar especificamente a ação sobre o assunto. Em alguns casos, isso é válido.

Recomendado: Sua conta foi validada pela equipe de suporte.
...
Recomendado: WhatsApp, obrigado, bom.
Não recomendado: wpp, valeu, massa.
...
Recomendado: Erro de login: A senha não está correta.
Não recomendado: Erro do sistema (código #2234): Ocorreu um erro de autenticação.
...
Teste seu conteúdo com frequência e revise quando for necessário
...
Usabilidade: Quando o hyperlink dá pistas para a ação ou destino, o usuário tem mais segurança em interagir.
...
Recomendado: "Saiba mais a respeito de acessibilidade".
Não recomendado: "Clique aqui para saber mais a respeito de acessibilidade".
Descrevendo com atributo “Title“
...
Copiar
Não recomendado:
<a href="educa.html" title="Leia mais notícias sobre Educação Superior"> Leia mais notícias sobre Educação Superior </a>
...
Forneça descrição para as imagens, vídeos e áudios. As descrições devem ser escritas em poucas palavras ou em uma frase curta (recomenda-se no máximo 125 caracteres). Porém, dependendo do tipo de conteúdo abordado e da complexidade das informações essa recomendação pode ser flexibilizada. Confira algumas boas práticas:
...
Por exemplo, os gráficos de dados funcionam bem em navegadores desktop, mas em outras plataformas (como celulares) podem ser difíceis de serem visualizados. Forneça estes dados dentro de uma planilha e/ou crie uma página apresentando os dados dentro de uma tabela.
...
Recomendado: Fernanda é surda. Ela diz que a leitura alternativa a ajuda a utilizar sistemas de maneira mais rápida e eficaz.
Não recomendado: Fernanda sofre de problemas auditivos. Ela diz que a leitura alternativa permite utilizar alguns sistemas.
...
Recomendado: Boas-vindas ao sistema portuário.
Não recomendado: Bem-vindo ao sistema portuário.
Recomendado: Dono(a) de negócio.
Não recomendado: Nossos colaboradores.
Dicionário de vocabulário controlado

Nosso dicionário é construído em conjunto com nossa comunidade e se encontra em constante atualização. Quanto mais padronizado o vocabulário, menor o esforço cognitivo.
...
Padrões Web em Governo Eletrônico e-PWG - Cartilha de Redação Web (Webwriting)
...
Linguagem Inclusiva e UX Writing: muito além de dicas