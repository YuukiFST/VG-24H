...
[!] [BRUNO] Rotas publicas + cidadao + autenticacao: raiz, servicos/, accounts/*, cidadao/*
[!] [FAUSTO] Rotas de equipe e gestao: equipe/*, gestao/*
"""
...
urlpatterns = [
    # ═══════════════════════════════════════════════════════════════
    # [BRUNO] Rotas Publicas
    # ═══════════════════════════════════════════════════════════════
    path("", views_root.root_view, name="root"),                                # Pagina inicial
    path("servicos/", views_root.catalogo_servicos, name="catalogo_servicos"),  # Catalogo publico

    # ═══════════════════════════════════════════════════════════════
    # [BRUNO] Autenticacao (accounts/*)
    # ═══════════════════════════════════════════════════════════════
