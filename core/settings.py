...
# Isso diz ao Django para abrir o arquivo .env e carregar as senhas na memória
load_dotenv()
...
# Agora o Django não tem mais a senha escrita. Ele vai "puxar" do seu arquivo .env
SECRET_KEY = os.environ.get('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
# O get puxa o texto 'True' do .env e o '==' transforma isso num booleano real do Python
